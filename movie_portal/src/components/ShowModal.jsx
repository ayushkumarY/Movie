  ...
  return (
    <>
      <div className="fixed left-0 right-0 bottom-0 top-0 backdrop-blur-sm bg-black bg-opacity-30 z-10">
        <div className="fixed w-[37rem] bg-gradient-to-b from-white to-purple-300 rounded-lg top-[30%] left-[30%] text-2xl p-7 pb-10">
          <button
            onClick={() => {
              setShowModal(false);
            }}
          ...
          <input
            ...
            className="border-2 border-purple-900 m-3 w-[500px] p-1 rounded-lg outline-none"
            value={year}
